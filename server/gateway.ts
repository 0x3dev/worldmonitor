...
const RPC_CACHE_TIER: Record<string, CacheTier> = {
  ...
  // 'live' (60s edge): downstream consumers poll this for breaking-news push
  // delivery — a 'slow' CDN tier would pin them to hour-stale digests no
  // matter how fresh the origin's Redis cache is.
  '/api/news/v1/list-feed-digest': 'live',
